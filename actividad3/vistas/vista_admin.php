...
if (isset($_POST["btnContBorrar"])) {
    ...
    if (isset($json_detalles["error_bd"])) {
        session_destroy();
        die(error_page("Actividad 3", "<h1>Listado de los productos</h1><p>" . $json_detalles["error_bd"] . "</p><p>Error consumiendo el servicio: " . $url . "</p>"));
    }
}
...
if (isset($_POST["h_cod"])) {
    ...
    if (!$json_detalles) {
        session_destroy();
        die(error_page("Actividad 3", "<h1>Listado de los productos</h1><p>Error consumiendo el servicio: " . $url . "</p>"));
    }
...
if (isset($_POST["btnContInsertar"])) {
    ...
    if (!$error_cod) {
        ...
        if (isset($json_repetido["error_bd"])) {
            session_destroy();
            die(error_page("Actividad 3", "<h1>Listado de los productos</h1><p>" . $json_repetido["error_bd"] . "</p><p>Error consumiendo el servicio: " . $url . "</p>"));
        }
...
if (isset($_POST["btnInsertar"]) || isset($_POST["btnContInsertar"])) {
    ...
    if (isset($json_familias["error_bd"])) {
        session_destroy();
        die(error_page("Actividad 3", "<h1>Listado de los productos</h1><p>" . $json_familias["error_bd"] . "</p><p>Error consumiendo el servicio: " . $url . "</p>"));
    }
}
...
if (isset($json_productos["error_bd"])) {
    session_destroy();
    die(error_page("Actividad 3", "<h1>Listado de los productos</h1><p>" . $json_productos["error_bd"] . "</p><p>Error consumiendo el servicio: " . $url . "</p>"));
}
